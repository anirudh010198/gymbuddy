 ...
 *  unchanged. /demo (src/pages/Demo.tsx) overrides this with an isolated,
 *  in-memory, pre-seeded store via GymStoreProvider, so it can never read or
 *  write a visitor's real progress. */
